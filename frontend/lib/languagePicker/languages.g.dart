...
class Languages {
  ...
  static Language get bhojpuri => Language('bho', 'Bhojpuri');
  ...
  static Language get cebuano => Language('ceb', 'Cebuano');
  static Language get chichewa => Language('ny', 'Chichewa');
  ...
  static Language get divehi => Language('dv', 'Divehi');
  ...
  static Language get filipino => Language('tl', 'Filipino');
  static Language get finnish => Language('fi', 'Finnish');
  static Language get french => Language('fr', 'French');
  static Language get frisian => Language('fy', 'Frisian');
  ...
  static Language get haitianCreole => Language('ht', 'Haitian Creole');
  static Language get hausa => Language('ha', 'Hausa');
  static Language get hawaiian => Language('haw', 'Hawaiian');
  static Language get hebrew => Language('iw', 'Hebrew');
  static Language get hindi => Language('hi', 'Hindi');
  static Language get hmong => Language('hmn', 'Hmong');
  ...
  static Language get krio => Language('kri', 'Krio');
  static Language get kurdishKurmanji => Language('ku', 'Kurdish (Kurmanji)');
  static Language get kurdishSorani => Language('ckb', 'Kurdish (Sorani)');
  static Language get kyrgyz => Language('ky', 'Kyrgyz');
  ...
  static Language get meiteilonManipuri =>
      Language('mni-Mtei', 'Meiteilon (Manipuri)');
  static Language get mizo => Language('lus', 'Mizo');
  static Language get mongolian => Language('mn', 'Mongolian');
  static Language get myanmarBurmese => Language('my', 'Myanmar (Burmese)');
  static Language get nepali => Language('ne', 'Nepali');
  static Language get northernSotho => Language('nso', 'Northern Sotho');
  static Language get norwegian => Language('no', 'Norwegian');
  static Language get odiaOriya => Language('or', 'Odia (Oriya)');
  static Language get oromo => Language('om', 'Oromo');
  static Language get pashto => Language('ps', 'Pashto');
  ...
  static Language get punjabi => Language('pa', 'Punjabi');
  ...
  static Language get scotsGaelic => Language('gd', 'Scots Gaelic');
  static Language get serbian => Language('sr', 'Serbian');
  static Language get sesotho => Language('st', 'Sesotho');
  ...
  static List<Language> defaultLanguages = [
    ...
    Languages.korean,
    Languages.krio,
    Languages.kurdishKurmanji,
    Languages.kurdishSorani,
    Languages.kyrgyz,
    Languages.lao,
    Languages.latin,
    Languages.latvian,
    ...
    Languages.maori,
    Languages.marathi,
    Languages.meiteilonManipuri,
    Languages.mizo,
    Languages.mongolian,
    Languages.myanmarBurmese,
    Languages.nepali,
    Languages.northernSotho,
    Languages.norwegian,
    Languages.odiaOriya,
    Languages.oromo,
    Languages.pashto,
